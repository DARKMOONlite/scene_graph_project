...
def main():
    ...
    try:
        ...
        for json_data in tqdm(data): #! Not the best method but it works for now
            ...
            # triples:list[tuple] = replace_object_ids_with_name(objects=json_data["objects"],triplets=triples) #! This breaks AnyBURL
            # print(f"Generated {len(triples)} triples from this file")
